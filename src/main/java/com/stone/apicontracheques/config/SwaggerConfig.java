...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.stone.apicontracheques.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API de Contracheques", "Esta API foi desenvolvida para estudo.", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Everton Mateus Fernandes", "https://www.linkedin.com/in/everton-mateus-fernandes/",
						"everton.mfernandes@gmail.com"),
