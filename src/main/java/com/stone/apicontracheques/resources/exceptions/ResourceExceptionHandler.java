package com.stone.apicontracheques.resources.exceptions;
...
import com.stone.apicontracheques.services.exceptions.FileException;
import com.stone.apicontracheques.services.exceptions.ObjectNotFoundException;
import com.stone.apicontracheques.services.exceptions.StandardError;
import com.stone.apicontracheques.services.exceptions.ValidationError;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> businessRule(BusinessRuleException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.CONFLICT.value(), "Integridade de dados", e.getMessage(), request.getRequestURI());
